...
from database import db, IdeaFile
from file_security import generate_secure_filepath, UPLOAD_BASE_DIR, validate_file_extension
...
def migrate_files():
    ...
    with app.app_context():
        ...
        if migrated > 0:
            ...
            print("   After verifying the migration worked correctly, you can delete them:")
